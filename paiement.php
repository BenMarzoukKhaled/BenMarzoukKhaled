...
$sql = "SELECT COUNT(*) AS NOMBRE,CLIENT_ID AS CLIENT  FROM TPS_FACTURATION WHERE STATUT ='Retard paiement' GROUP BY CLIENT_ID ";
...
<body style="background-color: #FEF8EF;">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a href="#" class="dropdown-item disabled">Paiement en attente</a></li>
                        </ul>
                    </li>
                    <li class="nav-item active">
    ...
    <div class="chartBox" style="margin-top: 150px; display: block; box-sizing: border-box; height: 400px; width: 700px;margin-left: 400px;">
        <h1 style="width: 777px;">Nombre de paiement en attente par client</h1>
    ...
    <script>
        ...
        const data = {
            labels: client,
            datasets: [{
                label: 'Nombre de paiement en attente',
                data: nombre,
                backgroundColor: [
                    'red',
                    'orange',
